          ...
          <div className="flex flex-col md:flex-row gap-12 items-center">
            <div className="md:w-1/2">
              ...
              <p className="text-lg text-muted-foreground mb-6">
                EnergyMon è leader nelle soluzioni di monitoraggio e ottimizzazione energetica per aziende di ogni dimensione. Da oltre 15 anni aiutiamo le imprese a ridurre i consumi, abbattere i costi e rispettare l'ambiente.
              </p>
      ...
      <footer className="bg-sidebar py-12 text-sidebar-foreground">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div>
              <h3 className="text-xl font-semibold mb-4">EnergyMon</h3>
              <p className="mb-4">
            ...
            <div>
              ...
              <address className="not-italic">
                ...
                <p className="mb-2">info@energymon.it</p>
                <p>+39 02 1234567</p>
              </address>
            </div>
            <div>
          ...
          <div className="mt-12 pt-8 border-t border-sidebar-border text-center">
            <p>&copy; {new Date().getFullYear()} EnergyMon. Tutti i diritti riservati.</p>
          </div>
        </div>
      </footer>
    </div>
